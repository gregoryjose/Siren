...
private extension Siren {
    ...
    func showAlert() {
        ...
        let updateAvailableMessage = Bundle.localizedString(forKey: alertTitle, forceLanguageLocalization: forceLanguageLocalization)
...
private extension Siren {
    ...
    func localizedUpdateButtonTitle() -> String {
        return Bundle.localizedString(forKey: updateButtonTitle, forceLanguageLocalization: forceLanguageLocalization)
    }
